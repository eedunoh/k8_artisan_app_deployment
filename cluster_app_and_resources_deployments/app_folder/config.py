...
class Config:
    APP_SECRET_KEY = "artisanapp0101"  # Fixed value
    ...
    def initialize(cls):
        ...
        cls.S3_BUCKET_NAME = cls.get_ssm_parameter("s3_bucket_name")
        cls.DYNAMO_NAME = cls.get_ssm_parameter("dynamodb_name")
        cls.REGION = cls.get_ssm_parameter("region")
